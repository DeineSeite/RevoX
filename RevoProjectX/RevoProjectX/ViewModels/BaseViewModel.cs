...
namespace RevoProjectX.ViewModels
{
    public class BaseViewModel : BaseNotify, IDirty
    {
        ...
        public async Task RunSafe(Task task, bool notifyOnError = true, [CallerMemberName] string caller = null, [CallerLineNumber] int line = 0, [CallerFilePath] string path = null)
        {
        ...
        public async Task<T> RunSafe<T>(Task<T> task, bool notifyOnError = true, [CallerMemberName] string caller = null, [CallerLineNumber] int line = 0, [CallerFilePath] string path = null)
        {
